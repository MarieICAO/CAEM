...
class HashTab :
    ...
    def database(txt) :
        "Provide an HashMap with the informations including in the OAG document."
    ...
    def runaways(txt) :
        "Provide an HashMap with the number of Runaways by Airport."
        Runaways = HashTab('IATA Airport Code',['IATA Airport Code','ICAO Airport Code','Airport Name','City Name','Country Code','Country Name','Number of Runaways'])
        for line in txt.data[1:] :
            l = line.split('\t')
            Runaways.htab[l[0]] = [l[0],l[1],l[2],l[3],l[4],l[5],int(l[6][0])]
        return Runaways
    
    def airport(self,Flights) :
        "Provide an HashMap with all the needed informations about the world Airports."
        Airports = HashTab('IATA Airport Code',['IATA Airport Code','ICAO Airport Code','Airport Name','City Name','Country Code','Country Name','Number of Runaways','Number of Flights In & Out','Number of Airlines'])
    ...
    def major(self,lim,prop) :
        ...
        Major = HashTab('IATA Airport Code',['IATA Airport Code','ICAO Airport Code','Airport Name','City Name','Country Code','Country Name','Number of Runaways','Number of Flights In & Out','Number of Airlines'])
    ...
    def land1(self,Country,Income) :
        ...
        State = HashTab('Country Code',['Country Code','Country Name','Number of Airport','Maximum Number of Runaways by Airport','Number of National Airlines','World Bank Income Category'])
        for line in self.htab.values() :
    ...
    def land2(self,Airlines,Income,nb):
        ...
        World = HashTab('Country Code',['Country Code','Country Name','World Bank Income Category','Number of National Airlines','Maximum Number of Runaways by Airport','Number of Flights In & Out','Global Number of Airports','Number of Airports by Categories of Size'])
        for key,line in Country.htab.items() :
